...
export type SortField = 'date' | 'severity' | 'location';
...
export interface ReportListProps {
  reports: Report[];
  onSelectReport: (selectedReport: Report) => void;
  onDeleteReport?: (reportToDelete: Report) => void;
  sortConfig?: SortConfig;
  onSort?: (fieldToSort: SortField) => void;
}
